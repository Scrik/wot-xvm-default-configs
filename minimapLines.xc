 ...
 */
{
  "lines": {
       ...
       "vehicle": [
         { "enabled": true, "from": 20,  "to": 300, "inmeters": false, "thickness": 1, "alpha": 80, "color": "0xFFCC66"}
       ],
       // Camera direction.
       ...
       "traverseAngle": [
         { "enabled": true, "from": 20,  "to": 300, "inmeters": false, "thickness": 0.4, "alpha": 80, "color": "0xFFCC66"}
       ]
    }
}